...
(tests/fixtures/kmeans_model_test.pkl) — tests never touch a developer's
real plaincents_v2.db or the production models/kmeans_model.pkl, and never
...
TEST_MODEL_PATH = Path(__file__).resolve().parent.parent.parent / "fixtures" / "kmeans_model_test.pkl"
