...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "Add a holding here. Prices come from a cache and only ever update when you click Refresh Prices — opening this page never triggers a market lookup on its own.",
  },
  {
    id: "how-it-works",
    route: "/how-it-works",
    ...
    body: "This page walks through exactly how categorization, corrections, and forecasting work under the hood — including their honest limits. That's the whole tour — take a look around, or dive in here.",
  },
];
